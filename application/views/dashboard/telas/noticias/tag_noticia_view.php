<h1 class='text-uppercase text-center'>Tags</h1>
<div class="col-md-5">
		...
		<form method='post' id='form_cadastrar_tag'>
				...
				<fieldset>
						...
						<p>Cadastre a descrição da tag somente se sua intenção for de mostrá-la no front-end de seu site.</p>
		...
		<script>
				$(document).ready(function () {
						$('#form_cadastrar_tag').submit(function () {
								var page = "<?=	base_url('dashboard/salvar_nova_tag')	?>";
...
<div class="col-md-7">
		<h3 class='text-center'>Lista de tags cadastradas</h3>
		<?php
		$categorias	=	Tag_model::getTodosOsTags();
		if	(is_string($categorias[0]))	{
				...
				foreach	($categorias	as	$categoria)	{
						...
						echo	"  <tr>
																...
																<td>$slug</td>
																<td>$descricao</td>
																<td><a href='$base/apagar_tag/$id' title='Apagar' class='btn btn-md btn-danger'>Apagar</a></td>
														</tr>";
				}
				echo	"  </tbody>
										</table>
