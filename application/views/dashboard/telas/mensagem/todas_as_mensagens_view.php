...
$msgs = Mensagem_model::getTodosOsMensagems();
...
if (is_string($msgs[0])) {
  ...
  foreach ($msgs as $msg) {
    ...
    echo "  <tr>
              <td align='center'><a href='$base/ler_mesagem/$id' title='$mensagem'>$icone</a></td>
              <td><a href='$base/ler_mensagem/$id' title='$mensagem'>$nome</a></td>
              <td><a href='$base/ler_mensagem/$id' title='$mensagem'>$email</a></td>
              <td><a href='$base/ler_mensagem/$id' title='$mensagem'>$telefone</a></td>
              <td><a href='$base/ler_mensagem/$id' title='$mensagem'>$mensagem</a></td>
              <td><a href='$base/ler_mensagem/$id' title='$mensagem'>$data_de_cadastro</a></td>
