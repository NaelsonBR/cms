...
if	(is_string($categorias[0]))	{
		echo	"<p>Não existem contatos cadastradas</p>";
}	else	{
		echo	"<a href='". base_url('dashboard/exportar_contatos_csv') ."' class='btn btn-lg btn-success'>Exportar contatos <i class='fa fa-download' aria-hidden='true'></i></a> <br /><br />";
		echo	"<div class='box'>";
